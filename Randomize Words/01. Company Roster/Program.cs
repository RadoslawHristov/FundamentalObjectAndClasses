    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < numberOfEmployees; i++)
            {
                ...
                departments.Find(d => d.DepartmentName == inputArr[2])
                    .AddNewEmployee(inputArr[0], decimal.Parse(inputArr[1]));

            }

            Department bestDepartment =
                departments.OrderByDescending(d => d.TotalSalaries / d.Employees.Count()).First();
